  ...
  <body>
    ...
    <section class="banner-area relative" id="home">
      ...
      <div class="container">
        ...
        >
          <div
            class="banner-content col-lg-10 col-md-12 justify-content-center"
          >
            ...
            <a href="#" class="primary-btn squire text-uppercase mt-10"
              >Check Our Menu</a
            >
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-9">
            ...
            <p>
              <span
                >We are here to listen from you deliver exellence by any
                means</span
              >
            </p>
            <p>
            ...
            <a class="primary-btn squire mx-auto mt-20" href="#"
              >Get Started Now</a
            >
          </div>
        </div>
    ...
    <section class="about-video-area section-gap">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div
            class="col-lg-6 about-video-right justify-content-center align-items-center d-flex"
          >
            <a
              class="play-btn"
              href="https://www.youtube.com/watch?v=ARA0AxrnHdM"
              ><img class="img-fluid mx-auto" src="img/play.png" alt
            /></a>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-9 pb-30 header-text">
            ...
            <p>
              Do you want to share your love of cheese fondue with your
              children? Or did you just find out that one of your fondue party
              guests doesn’t drink alcohol.
            </p>
          </div>
        </div>
        <div class="row">
          <div class="single-blog col-lg-4 col-md-4">
            ...
            <a href="#">
              <h4>Stocking Your Restaurant Kitchen Finding Reliable Sellers</h4>
            </a>
            <p>
              Saving money – is something we would all like to do. Whether you
              are struggling to manage day to day or earning a six figure
              salary, saving is something we all think about.
            </p>
          </div>
          <div class="single-blog col-lg-4 col-md-4">
            <div class="thumb">
    ...
    <script
      ...
      data-cf-beacon='{"rayId":"82536b209d114b62","version":"2023.10.0","token":"cd0b4b3a733644fc843ef0b185f98241"}'
      crossorigin="anonymous"
    ></script>
  </body>
</html>
