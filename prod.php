        ...
        <div class="container-fluid py-5">
            <div class="container text-center">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="card">
                            <img src="assets/offer3.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                    ...
                    <div class="col-3 mt-3">
                        <div class="card">
                            <img src="assets/offer6.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
                                <p class="card-text">Some quick example text to build on the card title and make up the
                                    bulk of the card's content.</p>
                    ...
                    <div class="col-3 mt-3">
                        <div class="card">
                            <img src="assets/offer4.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
                                <p class="card-text">Some quick example text to build on the card title and make up the
                                    bulk of the card's content.</p>
                    ...
                    <div class="col-3 mt-3">
                        <div class="card">
                            <img src="assets/offer7.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
                                <p class="card-text">Some quick example text to build on the card title and make up the
                                    bulk of the card's content.</p>
